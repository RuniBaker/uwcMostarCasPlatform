        ...
        <div class="relative flex-1 flex flex-col max-w-xs w-full bg-white">
            ...
            <div class="flex-1 h-0 pt-5 pb-4 overflow-y-auto">
                ...
                <nav class="px-4 space-y-1">
                    ...
                    <a href="/cas_leader/record_attendance?id=<?php echo $cas_id; ?>" class="text-gray-600 hover:bg-gray-50 hover:text-gray-900 group flex items-center px-2 py-2 text-sm font-medium rounded-md">
        ...
        <div class="flex-1">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
                <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center mb-6 sm:mb-8">
                    <div class="flex items-center">
                        <a href="/cas_leader/dashboard" class="mr-4 text-gray-600 hover:text-gray-800 text-sm sm:text-base">
                    ...
                    <div class="space-y-6 sm:space-y-8">
                        ...
                        <div class="bg-white rounded-lg shadow-md overflow-hidden">
                            <div class="bg-indigo-600 text-white px-4 sm:px-6 py-3 sm:py-4">
                                <h2 class="text-base sm:text-lg font-bold">Other CAS Leaders</h2>
                            </div>
